 ...
 *   https://datatables.net/download/#bs4/jq-3.6.0/dt-1.12.1/b-2.2.3/date-1.1.2/r-2.3.0
 *
 * Included libraries:
 *   jQuery 3 3.6.0, DataTables 1.12.1, Buttons 2.2.3, DateTime 1.1.2, Responsive 2.3.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/jq-3.6.0/dt-1.12.1/b-2.2.3/date-1.1.2/r-2.3.0",
